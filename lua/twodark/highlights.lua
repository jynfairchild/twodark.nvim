...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    ...
    hl.treesitter = {
        ...
        TSError = colors.TR,
        TSException = colors.TO,
        TSField = colors.TY,
        TSFloat = colors.TG,
        TSFunction = {fg = c.test_blue, fmt = cfg.code_style.functions},
        TSFuncBuiltin = {fg = c.test_teal, fmt = cfg.code_style.functions},
        TSFuncMacro = {fg = c.test_white, fmt = cfg.code_style.functions},
