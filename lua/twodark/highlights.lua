...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@text.emphasis"] = {fg = c.test_orange, fmt = 'italic'},
        ["@text.underline"] = {fg = c.test_orange, fmt = 'underline'},
        ["@text.strike"] = {fg = c.test_orange, fmt = 'strikethrough'},
        ["@text.title"] = {fg = c.test_orange, fmt = 'bold'},
        ["@text.literal"] = colors.test_orange,
        ["@text.uri"] = {fg = c.test_orange, fmt = 'underline'},
