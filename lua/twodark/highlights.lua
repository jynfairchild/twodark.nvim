...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    ...
    hl.treesitter = {
        ...
        TSInclude = colors.TR,
        TSKeyword = {fg = c.test_orange, fmt = cfg.code_style.keywords},
        TSKeywordFunction = {fg = c.test_yellow, fmt = cfg.code_style.functions},
        TSKeywordOperator =  {fg = c.test_green, fmt = cfg.code_style.keywords},
        TSLabel = colors.TT,
        TSMethod = {fg = c.test_blue, fmt = cfg.code_style.functions},
        TSNamespace = colors.TP,
        TSNone = colors.TW,
