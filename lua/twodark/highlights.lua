...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    ...
    hl.treesitter = {
        ...
        TSSymbol = colors.TR,
        TSTag = colors.TO,
        TSTagDelimiter = colors.TY,
        TSText = colors.TG,
        TSStrong = {fg = c.test_teal, fmt = 'bold'},
        TSEmphasis = {fg = c.test_blue, fmt = 'italic'},
        TSUnderline = {fg = c.test_purple, fmt = 'underline'},
        TSStrike = {fg = c.test_white, fmt = 'strikethrough'},
