...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@float"] = colors.TY,
        ["@include"] = colors.TG,
        ["@method"] = {fg = c.light_grey, fmt = cfg.code_style.functions},
        ["@namespace"] = colors.TB,
        ["@parameter"] = colors.TP,
        ["@preproc"] = colors.TW,
        ...
        ["@text.strong"] = {fg = c.light_grey, fmt = 'bold'},
        ["@text.emphasis"] = {fg = c.light_grey, fmt = 'italic'},
        ["@text.underline"] = {fg = c.light_grey, fmt = 'underline'},
        ["@text.strike"] = {fg = c.light_grey, fmt = 'strikethrough'},
        ["@text.title"] = {fg = c.light_grey, fmt = 'bold'},
        ["@text.literal"] = colors.light_grey,
        ["@text.uri"] = {fg = c.light_grey, fmt = 'underline'},
        ["@text.todo"] = {fg = c.test_red, fmt = cfg.code_style.comments},
        ["@text.todo.unchecked"] = {fg = c.test_red, fmt = cfg.code_style.comments},
        ["@text.todo.checked"] = {fg = c.test_green, fmt = cfg.code_style.comments},
        ["@text.math"] = colors.TP,
        ["@text.reference"] = colors.TP,
        ["@text.environment"] = colors.TW,
        ["@text.environment.name"] = colors.TW,
        ["@text.diff.add"] = colors.TY,
        ["@text.diff.delete"] = colors.TB,
    }
