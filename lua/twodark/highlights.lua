...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    ...
    hl.treesitter = {
        ...
        TSParameter = colors.TR,
        TSParameterReference = colors.TO,
        TSProperty = colors.TY,
        TSPunctDelimiter = colors.TG,
        TSPunctBracket = colors.TT,
        TSPunctSpecial = colors.TB,
        TSRepeat = {fg = c.test_purple, fmt = cfg.code_style.keywords},
        TSString = {fg = c.test_white, fmt = cfg.code_style.strings},
